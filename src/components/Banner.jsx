  ...
  return (
    <section className='container relative min-h-screen w-full px-8 py-[68px] flex items-center justify-center'>
      <div className='text-center flex flex-col items-center'>
        <h1 className='text-4xl md:text-6xl text-txt dark:text-dark-txt font-Agbalumo'>
          Hey! I'm <span className='text-amber font-Agbalumo'>Sukhdev</span>
        </h1>
        <h6 className='text-md md:text-2xl mt-6 md:leading-10 text-secondaryText dark:text-dark-secondaryText'>
