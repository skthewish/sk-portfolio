// images taken from https://undraw.co/
...
import ciestoSolutions from "../images/ciesto_logo.png";
...
export const experiences = [
  ...
  },
  {
    ...
    companyName: "Ciesto Solutions",
    icon: ciestoSolutions,
    iconBg: "#E6DEDD",
    date: "Dec 2024 - Present",
    points: [
      "Develop and maintain Next.js and Node.js applications, resolving technical challenges and optimizing performance.",
      "Collaborate with cross-functional teams, including designers, product managers, and developers, to create high-quality products.",
      "Lead React Native (Bare Workflow) mobile app development, ensuring smooth deployments for Android and iOS.",
      "Upgrade projects for major SDK updates, improving compatibility and stability.",
      "Debug and resolve issues, implementing optimized solutions to enhance performance and user experience.",
    ],
  },
];
...
export const socialLinks = [
  ...
  },
  {
    id: "instagram",
    icon: instagramIcon,
    link: `https://instagram.com/iamsk_.6?igshid=MzMyNGUyNmU2YQ==`,
  },
];
